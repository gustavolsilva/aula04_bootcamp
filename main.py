...
# Python não precisa tipar. 
# É por inferencia, ou seja, 
# em tempo de execução, ele entende 
# os tipos de dados nas variáveis
# Isso é chamado de Tipagem Dinâmica

#Type Hint = Dica de tipos
idade: int = 30
altura: float = 1.75
nome: str = "Alice"
...
# Refatorando o Desafio da Aula 03
